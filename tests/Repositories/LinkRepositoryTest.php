...
use WalkerChiu\MorphLink\Models\Repositories\LinkRepository;

class LinkRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->app->make(LinkRepository::class);
    }
    ...
    /**
     * A basic functional test on LinkRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testMorphLinkRepository()
    {
        // Config
    ...
    /**
     * Unit test about Lang creation on LinkRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphLink\Models\Repositories\MorphLinkRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(LinkLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on LinkRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphLink\Models\Repositories\MorphLinkRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        factory(Link::class)->create(['is_enabled' => 1]);
    ...
    /**
     * Unit test about Query List on LinkRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphLink\Models\Repositories\MorphLinkRepository
     *
    ...
    /**
     * Unit test about FormTrait on LinkRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphLink\Models\Repositories\MorphLinkRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Link::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            factory(Link::class)->create(['serial' => '123']);
            factory(Link::class)->create(['serial' => '124']);
            factory(Link::class)->create(['serial' => '125', 'is_enabled' => 1]);
            // When
    ...
    /**
     * Unit test about Auto Complete on LinkRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphLink\Models\Repositories\MorphLinkRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        factory(Link::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(Link::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Link::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Link::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Link::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
